...
[EditorModel( "models/gameplay/weapons/rocketlauncher/w_rocketlauncher.vmdl" )]
...
public partial class RocketLauncher : BulletDropWeapon<RocketProjectile>
{
	...
	public override string Crosshair => "ui/crosshair/crosshair121.png";
	...
	protected override void OnProjectileHit( RocketProjectile projectile, TraceResult trace )
	{
		...
		{
			DeathmatchGame.Explosion( projectile, projectile.Attacker, projectile.Position, 180f, 320f, 1f, 0.3f );
		}
		else
		{
